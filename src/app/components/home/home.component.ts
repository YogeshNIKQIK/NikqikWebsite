...
export class HomeComponent {
  ...
  @ViewChild('listBooks') listBooks!: ElementRef;
   ...
   slides = [
     ...
     { img: 'assets/images/cloud_14217783.png', title: 'Cloud Center Professional Services', description: 'In today digital world, exceptional customer experience is the key to loyalty and growth.', link: 'services-detail#cloud-contact-center-professional-services' },
